...
export default function PromptBlock({ prompt }) {
  ...
  return (
    <div className="prompt-block relative mt-5 rounded-xl border border-border/80 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-2.5 glass-strong border-b border-glass-border-strong">
      ...
      <pre className="font-[--font-mono] text-[13px] leading-relaxed p-4 sm:p-5 whitespace-pre-wrap select-text text-text-primary/85 bg-white/30 backdrop-blur-sm overflow-x-auto">
        {prompt}
      </pre>
    </div>
  )

...
export default function PaywallGate({ guide, children }) {
  ...
  return (
    <div>
      ...
      {/* Paywall overlay card — friendly soft card with a peach blob behind the lock */}
      <div className="relative mt-6 sm:mt-8 soft-card overflow-hidden p-8 sm:p-12 text-center">
        ...
        <div className="relative">
          ...
          <p className="text-ink-soft leading-relaxed max-w-lg mx-auto mb-8 text-base sm:text-lg">
            This guide has <strong className="text-ink font-semibold">{guide.steps.length} steps</strong>
            {' '}— prompts, frameworks, and templates built for your industry. Unlock for{' '}
            <strong className="text-ink font-semibold">{PRO_PRICE_DISPLAY}</strong>.
          </p>
